        ...
        <Container>
          <Row className="justify-content-center">
            <Col md="7" className="text-center">
              ...
              <h5 className="subtitle white_font">
              Participating teams and clubs are challenged to swim 26.2 miles and help save Spartan Swim and Dive. There will be prizes going to the fastest relays, top fundraisers, and individual finishers.
